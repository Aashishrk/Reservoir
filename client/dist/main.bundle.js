...
var appRoutes = [
    ...
    },
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_6__guards_notAuth_guard__["a" /* NotAuthGuard */]] // "Catch-All" Route
    },
    {
        path: 'stats',
    ...
    {
        path: '**', component: __WEBPACK_IMPORTED_MODULE_2__components_home_home_component__["a" /* HomeComponent */], } // Catch All Routes
];
...
var AuthService = (function () {
    function AuthService(http) {
        this.http = http;
        this.domain = "http://localhost:process.env.PORT"; // Development Domain - Not Needed in Production
    }
